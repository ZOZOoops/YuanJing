...
class AlibabaF2etest(unittest.TestCase,Keys):
    base_url = 'https://www.yuanjingio.com'
    def setUp(self) -> None:
        self.test_result = None

        caps = {}
        caps['caseName'] = 'Yuanjing'
        caps['browserName'] = 'chrome'
        caps['version'] = ''
        caps['f2etest.userid'] = 'lp01161602'
        caps['f2etest.apiKey'] = '6818ae3fb8d4ea08a40f4a011dd76c73'

        self.driver = webdriver.Remote(
            desired_capabilities=caps,
            command_executor='https://f2etest/alibaba-inc.com/wd/hub'
        )
        self.implicilty_wait(20)
